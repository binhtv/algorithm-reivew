...
public class CourseScheduleIV {
    public static List<Boolean> checkIfPrerequisite(int n, int[][] prerequisites, int[][] queries) {
        ...
        List<Integer>[] courses = new ArrayList[n];
        ...
        for (int[] query : queries) {
            result.add(courses[query[1]].contains(query[0]));
        }

        return result;
    }

    public static List<Boolean> checkV2(int n, int[][] prerequisites, int[][] queries) {
